...
[Faculty of Science at Charles University in Prague]{.fragment}
...
[Who lives in different types of the urban form and how does it differ across the country?]{.fragment}

[Is there a specific relationship between a group of people and an urban form type? How does it differ regionally?]{.fragment}
...
[Level 3: 6 urban form types in Czechia.]{.fragment}
...
![](../figures/202504_GISRUK/grid.png){height="600"}
...
![](../figures/202504_GISRUK/dense.jpeg){height="600"}
...
![](../figures/202504_GISRUK/krupka.jpg){height="600"}
...
![](../figures/202504_GISRUK/rural.png){height="600"}
...
![](../figures/202504_GISRUK/sparse.png){height="600"}
...
![](../figures/202504_GISRUK/panelaky.jpeg){height="600"}
...
::: aside
Target - most common urban form type for BSUs
:::
---
...
[Who lives in different types of the urban form? How does it differ across the country?]{.fragment}
...
[Controlled by a distance-decay parameter.]{.fragment data-fragment-index="0"}

[Nearby observations are given more weight than distant ones.]{.fragment data-fragment-index="1"}

<span class="fragment" data-fragment-index="2">
  ![](../figures/202504_GISRUK/bandwidth.png){height="300"}
</span>

<span class="fragment" data-fragment-index="2" style="font-size:0.4em">
...
[Controls the spatial scale over which a process varies.]{.fragment data-fragment-index="1"}

<span class="fragment" data-fragment-index="2">
  ![](../figures/202504_GISRUK/gwr_bw.png){height="400"}
</span>
...
[Outputs from dimensionality reduction →]{.fragment} [Geographically weighted Logistic Regression & Random Forest Classification]{.fragment}
...
1. Economic activity of the pupulation
