...
1. Nested intermediate aggregations
2. Nested spatial restrictions for each aggregation
3. Hierarchical operationalisations to create the aggregations, given the restrictions
