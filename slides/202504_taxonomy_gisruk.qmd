...
- The importance of elements and variables changes as we move through the taxonomy.

- We are using the first law of geography ( spatial autocorrelation ) to turn a computationally intractable problem into a solvable one.
