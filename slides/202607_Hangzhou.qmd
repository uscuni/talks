---
title: "Understanding the structure of space through data"
...
::: {.r-fit-text .absolute top=39%}
Urban morphometrics plays a role.
:::
...
![](../figures/202410_Nanjing/morphometrics_conzen.png){.absolute top=20%}
...
[Conceptually similar to historico-geographical approach in urban morphology.]{.fragment}
...
## {background-image="../figures/202504_GISRUK_simplification/fig_original-manual.png" background-size=80% .no-text}

::: aside
Transportation vs manually-derived morphological representation of a street network
:::
...
![](../figures/202607_Hangzhou/tmin.png){.absolute top=0%}

---

![](../figures/202607_Hangzhou/tmin_delta_l1.png){.absolute top=20%}

---

![](../figures/202607_Hangzhou/tmin_delta_l2.png){.absolute top=20%}

---

![](../figures/202607_Hangzhou/tmin_delta_l3.png){.absolute top=20%}
