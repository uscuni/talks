...
## {background-image="../figures/202604_GISRUK/locations.png" background-size="contain" .no-text}

<!-- ![](../figures/202604_GISRUK/locations.png){fig-align="center"} -->
...
## {background-image="../figures/202604_GISRUK/euclidean_knn.png" background-size="contain" .no-text}
...
## {background-image="../figures/202604_GISRUK/newtork_knn.png" background-size="contain" .no-text}
...
## {background-image="../figures/202604_GISRUK/graphs.png" background-size="contain" .no-text}
